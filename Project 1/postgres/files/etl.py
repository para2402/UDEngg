...
def process_song_file(cur, filepath):
    # open song file
    df = pd.read_json(filepath, lines=True, dtype=dict(duration=object, year=object))
...
def process_log_file(cur, filepath):
    ...
    time_data = dict(timestamp=df['ts'], hour=t.dt.hour, day=t.dt.day,
                     week=t.dt.week, month=t.dt.month,
                     year=t.dt.year, weekday=t.dt.dayofweek)
