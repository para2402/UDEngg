...
#     ## Using IAM role is more safe and a best practice
#     redshift_hook.run(sql_statements.COPY_ALL_TRIPS_SQL.format(Variable.get('redshiftS3Role')))
...
## This kind of a task/ operator is NOT needed if IAM role is being used
...
copy_task = PostgresOperator(
    ...
    dag=dag,
    postgres_conn_id="redshift",
    sql=sql_statements.COPY_ALL_TRIPS_SQL.format(Variable.get('redshiftS3Role'))
)
